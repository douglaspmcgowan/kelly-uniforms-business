...
|---|---|---|---|---|---|
| `mtuniforms.com` | Public OpenCart catalog/storefront loading Journal 3 assets | MT Uniforms LLC | Live on 2026-07-30; cart and connection failures are client-reported; temporary notice absent; direct empty-cart route loaded during the earlier bounded check | `MT_UNIFORMS_WEBSITE_ADMIN_USERNAME` and `MT_UNIFORMS_WEBSITE_ADMIN_PASSWORD` through the approved access path | `MSG-001`, `WEB-001`, `WEB-002`, `OBS-001`–`OBS-003`, `DEC-002` |
