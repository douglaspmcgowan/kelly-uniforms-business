...
- Use the three 2026-08-08 brand boards as concept directions only. No visual world is committed yet, so the design-language registry needs no project entry at this stage.
